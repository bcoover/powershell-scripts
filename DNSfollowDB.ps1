...
$exch01DNS = "mail1.extropy.com."
$exch03DNS = "mail3.extropy.com."
$Arecords = $exch01DNS,$exch03DNS

$server1 = "EXCH01"
$server2 = "EXCH03"
$servers = $server1,$server2

$EXCHarray = $server1,$exch01DNS,$server2,$exch03DNS

$DnsServerVar = "extropy-group.com"
